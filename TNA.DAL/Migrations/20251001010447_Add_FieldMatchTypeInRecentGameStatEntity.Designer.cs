...
namespace TNA.DAL.Migrations
{
    ...
    [Migration("20251001010447_Add_FieldMatchTypeInRecentGameStatEntity")]
    partial class Add_FieldMatchTypeInRecentGameStatEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TNA.DAL.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TNA.DAL.Entities.User", b =>
                {
                    b.HasOne("TNA.DAL.Entities.ClanMember", "Member")
                        .WithMany()
